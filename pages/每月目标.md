# 2024年
	...
	- ## 10月
		...
		- 运动！这个月跑完40km！当前：`7km / 40km`
		  logseq.order-list-type:: number
		- ## 10.7-10.13
			- 学习blender建模，要能够学习建模简单几何体并做笔记（目的是下面这个）
			  :LOGBOOK:
			  ...
			  :END:
				- DOING blender的视图操作
				  :LOGBOOK:
				  CLOCK: [2024-10-09 Wed 10:35:22]
				  CLOCK: [2024-10-09 Wed 10:35:26]
				  :END:
				- DOING blender的对象操作（仅是放缩，旋转，位置调整之类的，要涉及到磁吸等）
				  :LOGBOOK:
				  CLOCK: [2024-10-09 Wed 10:35:33]
				  :END:
